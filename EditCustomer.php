    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="jumbotron">
                        <form method="POST" action="EditCustomer.php" id="editForm">
                            <div class="form-group">
                                ...
                                if (isset($_SESSION['email'])) {
                                    ...
                                    //email not id?
                                    $result = $connection->find_one('customer', 'email', $_SESSION['email']);
                                }
                                ?>
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?php echo $result['phone'] ?>"type="number" class="form-control" id="phone" name="phone" required="">
                            </div>
        ...
        if(isset($_POST['firstname'])) {
            ...
            $c = new Customer('', $_POST['firstname'], $_POST['lastname'], $_POST['email'], $_POST['password'], $_POST['phone'], '');
            $c->edit($result['id']);
